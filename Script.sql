...
insert into albums select * from (select 1 as id,
                                  ...
                                  union all
                                  select 5, 'YOUR WAY!!!', to_char(current_date - 365, 'yyyy')
                                  union all
                                  select 6, 'SUB WAY!!!', to_char(current_date - 730, 'yyyy')
                                  union all
                                  select 7, 'CHASE THE SUN!!!', to_char(current_date, 'yyyy')
                                  union all
                                  select 8, 'CHASE THE MOON!!!', to_char(current_date - 365, 'yyyy')
                                  union all
...
insert into compilation_albums select generate_series as id,
                                      ...
                                      to_char(current_date - 250 * generate_series, 'yyyy') as comp_year
